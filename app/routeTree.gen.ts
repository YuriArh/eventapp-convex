...
import { Route as AuthedConvexpostsImport } from './routes/_authed/convexposts'
...
const AuthedConvexpostsRoute = AuthedConvexpostsImport.update({
  id: '/convexposts',
  path: '/convexposts',
  getParentRoute: () => AuthedRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authed/convexposts': {
      id: '/_authed/convexposts'
      path: '/convexposts'
      fullPath: '/convexposts'
      preLoaderRoute: typeof AuthedConvexpostsImport
...
interface AuthedRouteChildren {
  AuthedConvexpostsRoute: typeof AuthedConvexpostsRoute
  AuthedPostsRoute: typeof AuthedPostsRouteWithChildren
  AuthedProfileSplatRoute: typeof AuthedProfileSplatRoute
}

const AuthedRouteChildren: AuthedRouteChildren = {
  AuthedConvexpostsRoute: AuthedConvexpostsRoute,
...
export interface FileRoutesByFullPath {
  ...
  '/convexposts': typeof AuthedConvexpostsRoute
...
export interface FileRoutesById {
  ...
  '/_authed/convexposts': typeof AuthedConvexpostsRoute
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authed/convexposts": {
      "filePath": "_authed/convexposts.tsx",
      "parent": "/_authed"
    },
    "/_authed/posts": {
